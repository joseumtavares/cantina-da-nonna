...
-- Melhoria: dados iniciais baseados no cardapio completo do front-end.

-- ==========================================================
-- DADOS INICIAIS - CANTINA DA NONNA
-- Este arquivo insere as categorias e produtos que ja aparecem
-- no cardapio HTML atual. INSERT IGNORE evita duplicidade ao
-- reiniciar a aplicacao varias vezes durante os estudos.
-- ==========================================================

USE `nona-db`;
SET NAMES utf8mb4;

-- Categorias principais do cardapio.
...
-- Produtos da categoria Entradas.
...
-- Produtos da categoria Sobremesas.
INSERT IGNORE INTO produtos (categoria_id, codigo, nome, descricao, valor, imagem, ativo, destaque, ordem_exibicao) VALUES
...
-- Usuarios administrativos ficam sem seed por seguranca.
-- Quando criarmos login, vamos salvar senha_hash usando BCrypt ou algoritmo equivalente.